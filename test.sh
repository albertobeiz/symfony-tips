...
printf "\n\n"
curl -d '{"email":"b@a.a", "username":"aa"}' -H "Content-Type: application/json" -X POST https://localhost:8000/users
printf "\n\n"
curl -d '{"email":"c@a.a", "username":"aa"}' -H "Content-Type: application/json" -X POST https://localhost:8000/users
printf "\n\n"
